...
let IconUser: FC<IconfontProps> = ({ size, color, ...rest }) => {
  const xml = `
  <svg t="1626858595848" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2002" xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32">
